...
export const authValidate = (validationCase: "login" | "register" | "forgot" | "reset") => {
    switch (validationCase) {
        ...
        case "forgot":
            return [
                body("email").notEmpty().withMessage(errorMessages("required", "email"))
                    .isEmail().withMessage(errorMessages("email", "email"))
            ];
